...
import TransactionFailedDialog from "../components/TransactionFailedDialog";
...
const products = [
  {
    ...
    imageAlt: "Front of men's Bassic Tee in black.",
  },
  // More products...
]
...
const paymentMethods = [
  {id: 'MtnMobileMoney', title: 'MTN MOBILE MONEY'},
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
          <div>
            <div>
              {/* Payment */}
              <div>
                <h2 className="text-lg font-medium text-gray-900">Information de paiement</h2>
                  ...
                  <div className="col-span-4">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        name="phone-number"
                        autoComplete="tel"
                        placeholder="Exemple : +2250708090102"
            ...
            <div className="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
              ...
              <dl className="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
                <div className="flex items-center justify-between">
                  ...
                  <dd className="text-sm font-medium text-gray-900">210.48</dd>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                  ...
                  <dd className="text-base font-medium text-gray-900">$220.0</dd>
                </div>
              </dl>
              ...
              {showAlert && (
                <Alert message="Veuillez remplir tous les champs" onClose={closeAlert}/>
              )}
              {/* Ajoutez ce bloc de code */}
              <TransactionFailedDialog open={open} setOpen={setOpen}/>
